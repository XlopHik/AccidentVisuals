...
public class HitEffect extends ModuleStructure {
    ...
    public ColorSetting colorSetting = new ColorSetting("accident.module.hiteffect.setting.colorsetting.name", "accident.module.hiteffect.setting.colorsetting.desc")
            .setColor(new Color(137, 97, 72, 255).getRGB());

    public HitEffect() {
        super("accident.module.hiteffect.name", "accident.module.hiteffect.desc", ModuleCategory.RENDER);
