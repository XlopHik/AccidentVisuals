...
public class BindComponent extends AbstractSettingComponent {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Fonts.TEST.draw(getSetting().getName(), x + 3.7f, y + height / 2 - 4.7f, 6, applyAlpha(new Color(210, 210, 220, 200)).getRGB());
    ...
    private void renderBindText(float boxX, float boxY, float boxWidth, float boxHeight, BindSetting bindSetting) {
        ...
        if (textChangeAnimation < 1f && !previousBindText.equals(currentBindText)) {
            ...
            if (oldAlpha > 0.01f) {
                ...
                Fonts.TEST.drawCentered(previousBindText, centerX, textY + oldOffsetY, 5, oldColor.getRGB());
            }
            ...
            Fonts.TEST.drawCentered(currentBindText, centerX, textY + newOffsetY, 5, newColor.getRGB());
        } else {
            Fonts.TEST.drawCentered(currentBindText, centerX, textY, 5, textColor.getRGB());
        }
    }
