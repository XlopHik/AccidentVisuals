...
import accident.mixin.ClientConnectionAccessor;
import accident.mixin.IClientWorld;
...
public class NetworkUtility implements IMinecraft {
    ...
    public void pauseEvents() { shouldTriggerEvent = false; }
    public void resumeEvents() { shouldTriggerEvent = true; }
    public boolean shouldTriggerEvent() { return shouldTriggerEvent; }

    public void updateServerSprint(boolean sprint) { serverSprinting = sprint; }
    public boolean serverSprinting() { return serverSprinting; }
