...
public class ColorUtil {
    ...
    public int getHealthColor(float health, float maxHealth) {
        ...
        int red = (int) (255 * Math.min(1.0f, 2.0f * (1.0f - ratio)));
        int green = (int) (255 * Math.min(1.0f, 2.0f * ratio));
    ...
    public static int withAlphahud(int color, int alpha) { return (alpha << 24) | (color & 0x00FFFFFF); }
    public static int withAlpha(int color, float alpha) { return withAlphahud(color, (int) (alpha * 255)); }
    ...
    public int getColor(int red, int green, int blue) { return getColor(red, green, blue, 255); }
    ...
    private String generateKey(int red, int green, int blue, int alpha) { return red + "," + green + "," + blue + "," + alpha; }
    ...
    public String removeFormatting(String text) { return text == null || text.isEmpty() ? null : FORMATTING_CODE_PATTERN.matcher(text).replaceAll(""); }
    ...
    public int getRectDarker(float alpha) { return multAlpha(new Color(0x18181E).getRGB(),alpha); }
    ...
    public int getFriendColor() { return new Color(0x55FF55).getRGB(); }
    ...
    public int getOutline() { return new Color(0x373746).getRGB(); }
}