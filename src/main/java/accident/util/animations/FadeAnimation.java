...
public class FadeAnimation {
    ...
    public boolean isDone() { return System.currentTimeMillis() - startTime >= duration; }
    public boolean isFullyHidden() { return isDone() && !forwards; }
    public boolean isFullyVisible() { return isDone() && forwards; }
}