    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("accident", "core/arc"))
                    .withVertexShader(Identifier.of("accident", "core/arc_vertex"))
                    .withFragmentShader(Identifier.of("accident", "core/arc_fragment"))
