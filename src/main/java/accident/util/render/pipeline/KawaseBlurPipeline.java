...
public class KawaseBlurPipeline {
    ...
    private static final Identifier DOWN_PIPELINE_ID = Identifier.of("accident", "pipeline/kawase_down");
    private static final Identifier DOWN_VERTEX_SHADER = Identifier.of("accident", "core/kawase_down");
    private static final Identifier DOWN_FRAGMENT_SHADER = Identifier.of("accident", "core/kawase_down");

    private static final Identifier UP_PIPELINE_ID = Identifier.of("accident", "pipeline/kawase_up");
    private static final Identifier UP_VERTEX_SHADER = Identifier.of("accident", "core/kawase_up");
    private static final Identifier UP_FRAGMENT_SHADER = Identifier.of("accident", "core/kawase_up");

    // блюр должен полностью перезаписывать таргет, а не блендиться - иначе на
    // низкоальфовых источниках (fire trail) старые кадры копятся в смазанный след,
    // и очистка trail-буфера тут не спасает, т.к. мусор живёт в этих текстурах
