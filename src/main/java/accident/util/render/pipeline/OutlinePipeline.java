...
public class OutlinePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("accident", "pipeline/outline");
    private static final Identifier VERTEX_SHADER = Identifier.of("accident", "core/outline");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("accident", "core/outline");
    ...
    private void uploadAndDraw(MinecraftClient client) {
        ...
        accident.util.render.DrawTimes.outline(accidentT0);
    }
