    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("accident", "core/arc_outline"))
                    .withVertexShader(Identifier.of("accident", "core/arc_outline_vertex"))
                    .withFragmentShader(Identifier.of("accident", "core/arc_outline_fragment"))
